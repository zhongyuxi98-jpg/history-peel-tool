...
<body>
    <div class="main">
        ...
        <button class="ai-review-trigger" id="ai-btn" onclick="reviewAI()">🚀 SUBMIT FOR AI TEACHER'S REVIEW</button>
    ...
    <script>
        ...
        async function explain(topic) {{
            ...
            const lang = document.getElementById('language-setting').value;
